...
<head>
    ...
    <style>
        ...
        .lesson-complete + .trail-lesson .lesson-connector {
...
<body>
    ...
    <script>
        ...
        function abrirLicao(idx) {
            // Redirecionar para a página de quiz da lição
            const modulo = <?php echo $modulo_selecionado; ?>;
            window.location.href = `trilha_licao_quiz.php?modulo=${modulo}&licao=${idx}`;
        }
    </script>
